...
app_de = Label(frame_baixo, text='De', width=16, height=1, relief='flat', anchor=NW, font=('Ivy 10  bold'), bg=cor0, fg=cor1)
...
app_para = Label(frame_baixo, text='Para', width=16, height=1, relief='flat', anchor=NW, font=('Ivy 10  bold'), bg=cor0, fg=cor1)
...
botao = Button(frame_baixo,command=converter, text='Converter', width=19, pady=5, height=1, bg=cor2, fg=cor0, font=('Ivy 12 bold'), relief='raised', overrelief=RIDGE)
